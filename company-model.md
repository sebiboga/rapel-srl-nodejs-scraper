...
|---------|--------|-------------|
| id      | string | CIF/CUI of the company (7 digits, no RO prefix) |
...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "RAPEL") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/rapel-srl-nodejs-scraper/master/.github/workflows/scrape.yml`)
