# RAPEL SRL — Node.js Scraper

**rapel-srl-nodejs-scraper** — scraper pentru job-urile RAPEL SRL.

Extrage anunțurile de pe [jobRapid.ro](https://www.jobrapid.ro) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
1. **Validează compania** — interoghează API-ul public ANAF ([demoanaf.ro](https://demoanaf.ro)) după CIF-ul RAPEL (5665609) și verifică:
   - Denumirea oficială: RAPEL SRL
...
6. **Generează docs/jobs.md** — fișier markdown cu informații companie + toate job-urile curente, publicat pe [GitHub Pages](https://sebiboga.github.io/rapel-srl-nodejs-scraper/jobs.md)
...
├── index.js                    # Orchestrator principal (cheerio scraping)
...
|---|---|---|
| jobRapid.ro | `https://www.jobrapid.ro` | Public |
...
jobRapid.ro [robots.txt](https://www.jobrapid.ro/robots.txt) — analizat în [ROBOTS.md](../ROBOTS.md). Scraper-ul respectă regulile cu rate limiting (1s delay între pagini) și un singur User-Agent identificabil.
...
> **Derivat din** [epam-systems-international-srl-nodejs-scraper](https://github.com/sebiboga/epam-systems-international-srl-nodejs-scraper) — template-ul de referință pentru scraper-ele Node.js din ecosistemul peviitor.ro.
